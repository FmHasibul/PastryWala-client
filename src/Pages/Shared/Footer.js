    ...
    return (
        <footer className="footer p-10 bg-base-200 text-base-content">
            <div>
                ...
                <Link className="link link-hover">Cakes</Link>
                <Link className="link link-hover">Part Items</Link>
                <Link className="link link-hover">Fast Food</Link>
                <Link className="link link-hover">Ready Made food</Link>
            </div>
            <div>
            ...
            <div>
                ...
                <div className="form-control w-80">
                    ...
                    <div className="relative">
                        ...
                        <button className="btn btn-secoundary absolute top-0 right-0 rounded-l-none">Subscribe</button>
                    </div>
                </div>
            </div>
            <div>
                <span className="footer-title">Social Platfrom</span>
