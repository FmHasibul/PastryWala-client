        ...
        <div className=''>
            <div class="banner">
                <div className="header opacity-75 bg-slate-900 mx-auto text-center pb-16">
                    <h1 className="text-zinc-50 text-6xl font-bold py-16">The best Food is here for you </h1>
                    <div className="desc text-zinc-200 text-2xl font-normal mb-8">
                        <p>I Decorate With Passion, to ensure the best taste for you and your family</p>
                        <p>Join our Social community. <span className="font-bold">It's Open for Discusion.</span></p>
                    </div>
